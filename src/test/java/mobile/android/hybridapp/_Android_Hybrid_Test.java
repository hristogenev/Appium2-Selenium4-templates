package mobile.android.hybridapp;
...
public class _Android_Hybrid_Test {
  ...
  public void setUp() throws Exception {
    UiAutomator2Options options = new UiAutomator2Options()
        ...
        .setApp("PUBLIC:io.perfecto.webviewdemo-setWebContentsDebuggingEnabled.apk")
        .setAppPackage("io.perfecto.webviewdemo")
        ;
    ...
    PerfectoExecutionContext perfectoExecutionContext = new PerfectoExecutionContext.PerfectoExecutionContextBuilder()
        .withProject(new Project("Perfecto.Support Android tests", "1.0"))
        .withJob(new Job("Perfecto.Support Android tests", 1))
  ...
  @Test
  public void AndroidTest1() throws InterruptedException {
    reportiumClient.testStart("Android Hybrid Test", new TestContext());

    driver.activateApp("io.perfecto.webviewdemo");
