...
public class _Ios_Web_Test {
  ...
  public void setUp() throws Exception {
    ...
    perfectoOptions.put("openDeviceTimeout", 1);
  ...
  @Test
  public void iOSWebTest1() throws InterruptedException {
    reportiumClient.testStart("iOS Web Test", new TestContext());
