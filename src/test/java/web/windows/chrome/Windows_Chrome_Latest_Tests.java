...
public class Windows_Chrome_Latest_Tests {
  ...
  @Test
  public void webTestOnWindowsChrome1() throws Exception {
    reportiumClient.testStart("Web Test on Windows Chrome Open DuckDuckGo", new TestContext());
  ...
  @Test
  public void webTestOnWindowsChrome2() throws Exception {
    reportiumClient.testStart("Web Test on Windows Chrome Open Google", new TestContext());
