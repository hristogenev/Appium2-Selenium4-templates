...
public class Windows_Edge_Latest_Tests {
  ...
  @Test
  public void webTestOnWindowsEdge1() throws Exception {
    reportiumClient.testStart("Web Test on Windows Edge Open DuckDuckGo", new TestContext());
  ...
  @Test
  public void webTestOnWindowsEdge2() throws Exception {
    reportiumClient.testStart("Web Test on Windows Edge Open Google", new TestContext());
