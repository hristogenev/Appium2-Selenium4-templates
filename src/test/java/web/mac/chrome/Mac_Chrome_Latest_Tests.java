...
public class Mac_Chrome_Latest_Tests {
  ...
  @Test
  public void webTestOnMacChrome1() throws Exception {
    reportiumClient.testStart("Web Test on Mac Chrome Open DuckDuckGo", new TestContext());
  ...
  @Test
  public void webTestOnMacChrome2() throws Exception {
    reportiumClient.testStart("Web Test on Mac Chrome Open Google", new TestContext());
