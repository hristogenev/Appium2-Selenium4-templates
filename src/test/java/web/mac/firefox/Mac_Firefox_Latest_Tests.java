...
public class Mac_Firefox_Latest_Tests {
  ...
  @Test
  public void webTestOnMacFirefox1() throws Exception {
    reportiumClient.testStart("Web Test on Mac Firefox Open DuckDuckGo", new TestContext());
  ...
  @Test
  public void webTestOnMacFirefox2() throws Exception {
    reportiumClient.testStart("Web Test on Mac Firefox Open Google", new TestContext());
